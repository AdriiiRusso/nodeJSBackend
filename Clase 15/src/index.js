...
const server = app.listen(PORT, () => {
    console.log(`Frontend: \t\t\t http://localhost:${PORT}/api/usuario`)
    console.log(`Randoms en: \t\t\t http://localhost:${PORT}/test/randoms`)
    console.log(`Información del sistema en: \t http://localhost:${PORT}/test/info`)
    console.log(`Backend: \t\t\t http://localhost:${PORT}/api/productos\n\t\t\t\t http://localhost:${PORT}/api/carrito`)
})
